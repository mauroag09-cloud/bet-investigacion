...
const claims = [
  {
    ...
    status: 'reviewing', // reviewing | resolved | pending
    date: '15/08/2026',
  ...
  return (
    <section className="py-16 bg-[#F5F0E6] border-y border-[#B08D57]/20">
      <div className="container mx-auto px-6">
        {/* Encabezado con sello de advertencia */}
              ...
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <span
                    ...
                    style={{ backgroundColor: statusConfig[claim.status].color }}
                  />
                ...
                <span
                  className={`text-[10px] font-ibm-mono px-2 py-0.5 rounded ${statusConfig[claim.status].bg}`}
                  style={{ color: statusConfig[claim.status].color }}
                >
