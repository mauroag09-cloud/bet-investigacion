  ...
  return (
    <section className="py-16 bg-tinta text-papel">
      <div className="container mx-auto px-6 text-center max-w-3xl">
        <span className="inline-block font-ibm-mono text-xs tracking-[0.2em] text-oro mb-4">JUEGO RESPONSABLE</span>
        <h2 className="font-fraunces text-3xl md:text-4xl font-bold">Apostá con conciencia</h2>
