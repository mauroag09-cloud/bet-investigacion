...
// Datos de ejemplo (luego conectarás con API)
const promotions = [
  {
    id: 1,
    platform: 'Joker.top',
  ...
  {
    id: 5,
    platform: 'Golden Tiger',
    status: 'active',
    value: '300%',
    label: 'DE BONO',
    condition: 'Hasta $1000',
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-2 font-inter text-sm text-[#14213D]/60 max-w-md mx-auto">
            Ofertas verificadas por nuestro equipo. Solo promociones con condiciones claras y justas.
          </p>
        </div>
        ...
        <div className="mt-10 overflow-x-auto pb-4 scrollbar-hide">
          <div className="flex gap-5 min-w-max md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 md:min-w-0">
            {promotions.map((promo) => (
              ...
              >
                {/* Borde punteado interior (simula estampilla) */}
                <div
                  className="absolute inset-[4px] border-2 border-dashed border-[#B08D57]/30 rounded pointer-events-none"
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <span
                      ...
                      style={{ backgroundColor: statusColors[promo.status] }}
                    />
                ...
                <div className="text-center py-2">
                  <span className="font-fraunces text-4xl md:text-5xl font-black text-[#14213D]">
                    {promo.value}
                  </span>
                ...
                {/* Condición */}
                <p className="text-center font-ibm-mono text-[11px] text-[#14213D]/60">
                  {promo.condition}
                </p>

                {/* Botón */}
                <button
                  className="w-full mt-4 py-2 bg-[#14213D] text-white text-sm font-inter font-medium rounded hover:bg-[#14213D]/90 transition-colors"
                  style={{ borderRadius: '4px' }}
                >
                  Activar →
                </button>
